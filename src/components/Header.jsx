      ...
      <div className="sm:px-8 lg:grid lg:gap-x-8">
        <div>
          <h1 className="font-bold text-2xl sm:text-3xl lg:text-5xl mb-2">
            Increase efficiency by automating bookings and customer inquiries
          </h1>
          <h2 className="font-semibold text-xl sm:text-2xl lg:text-3xl mb-2">
            – let AI manage the routine tasks, allowing you to focus on
            ...
            <li>
              <li>
                <h1 className="font-medium text-xl mb-4">
                  Automate reservation bookings & follow-ups – Cut down
                  operational tasks by up to 35%.
                </h1>
              </li>
              <li>
                <h1 className="font-medium text-xl mb-4">
                  Elevate customer service – Improve guest engagement by up to
                  25% with our smart chatbot.
                </h1>
              </li>
              <li>
                <h1 className="font-medium text-xl mb-4">
                  Seamless AI integration to streamline your restaurant
                  operations.
                </h1>
              </li>
            </li>
